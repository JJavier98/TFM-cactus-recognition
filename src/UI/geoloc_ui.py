"""
    ...
    para la ejecución del script "geoloc_cacti.py"
"""
...
class UI(ttk.Frame):
    """
    Clase para crear la interfaz gráfica del programa para geolocalizar cactus.
    ...
    def __init__(self, main_function):
        ...
        self.parent.iconbitmap("src/ico/location.ico")

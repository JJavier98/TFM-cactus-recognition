"""
Crea carpetas con subconjuntos de entrenamiento, validación y test
"""
import os
import random
import shutil
...
def split_dataset(source_folder, train_folder, val_folder, # test_folder,
    ...
    Args:
        ...
        train_size (int, optional): número de imágenes para el conjunto de
            entrenamiento. Defaults to 80.
        validation_size (int, optional): número de imágenes para el conjunto de
            validación. Defaults to 20.
    """
...
if __name__ == '__main__':
    source_imgs_folder = os.path.join('data','imgs','bing_maps','bing_saguaro_z21_clean')
    train_imgs_folder = os.path.join('data','imgs','bing_maps','bing_saguaro_z21_train')
    val_imgs_folder = os.path.join('data','imgs','bing_maps','bing_saguaro_z21_val')
    # test_imgs_folder = os.path.join('data','imgs','bing_maps','bing_saguaro_z21_test')

    split_dataset(source_imgs_folder, train_imgs_folder, val_imgs_folder)
